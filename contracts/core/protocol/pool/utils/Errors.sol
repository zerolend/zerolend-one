...
library Errors {
  ...
  string public constant CALLER_NOT_ASSET_LISTING_OR_POOL_ADMIN =
    'CALLER_NOT_ASSET_LISTING_OR_POOL_ADMIN'; // 'The caller of the function is not an asset listing or pool admin'
  ...
  string public constant HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD =
    'HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD'; // 'Health factor is lesser than the liquidation threshold'
  ...
  string public constant COLLATERAL_SAME_AS_BORROWING_CURRENCY =
    'COLLATERAL_SAME_AS_BORROWING_CURRENCY'; // 'Collateral is (mostly) the same currency that is being borrowed'
  string public constant AMOUNT_BIGGER_THAN_MAX_LOAN_SIZE_STABLE =
    'AMOUNT_BIGGER_THAN_MAX_LOAN_SIZE_STABLE'; // 'The requested amount is greater than the max loan size in stable rate mode'
  ...
  string public constant NO_EXPLICIT_AMOUNT_TO_REPAY_ON_BEHALF =
    'NO_EXPLICIT_AMOUNT_TO_REPAY_ON_BEHALF'; // 'To repay on behalf of a user an explicit amount to repay is needed'
  ...
  string public constant UNDERLYING_CLAIMABLE_RIGHTS_NOT_ZERO =
    'UNDERLYING_CLAIMABLE_RIGHTS_NOT_ZERO'; // 'Claimable rights over underlying not zero (aToken supply or accruedToTreasury)'
